...
live-ablation: ## E30 — live-caption input contract ablation (LIVE-0/1/2 + diagnostic)
	$(PYTHON) -m audire.cli live-ablation --config experiments/configs/e30_live_contract.yaml
